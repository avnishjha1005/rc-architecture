...
export default async function BlogPage() {
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.posts}><div className={styles.tabs}><h2>{page?.primaryTabLabel || "Space Labs"} <sup>[{String(articles.length).padStart(2, "0")}]</sup></h2><span>|</span><h2>{page?.secondaryTabLabel || "Space Making"} <sup>[09]</sup></h2></div><SpaceLabsGrid articles={articles} /></section>
